      ...
      <main className="pt-24">
        <section className="py-20 md:py-28 text-center">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <h1 className="font-display text-5xl md:text-6xl font-black text-espresso-800 dark:text-sand-50 tracking-tight mb-4 leading-[0.95]">
              {reviewsContent.headline || "What Clients Say"}
            </h1>
            {reviewsContent.subtext && (
              <p className="text-espresso-500 dark:text-espresso-400 mb-6 font-light">{reviewsContent.subtext}</p>
            )}
        ...
        <section className="max-w-7xl mx-auto px-6 pb-24">
          {reviews.length === 0 ? (
            <p className="text-center text-espresso-400 py-16">No reviews yet. Be the first to leave one below!</p>
          ) : (
        ...
        <section className="py-20 bg-[#dedad2] dark:bg-zinc-900/50">
          <div className="max-w-2xl mx-auto px-6">
            <div className="text-center mb-10">
              <h2 className="font-display text-3xl md:text-4xl font-black text-espresso-800 dark:text-sand-50 mb-3 leading-tight">
                {reviewsContent.cta_title || "Leave a Review"}
              </h2>
              <p className="text-espresso-500 dark:text-espresso-400 font-light">
                {reviewsContent.cta_text || "Worked with us? Reviews are published within 24 hours after approval."}
              </p>
            </div>
            <div className="bg-[#faf8f4] dark:bg-zinc-900 border border-sand-200 dark:border-espresso-700 p-8 shadow-lg">
              <ReviewForm />
            </div>
          </div>
        </section>
