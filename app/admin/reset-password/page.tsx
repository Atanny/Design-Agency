...
export default function ResetPasswordPage() {
 ...
 <span className="w-12 h-12 gradient-gold flex items-center justify-center text-white font-display font-black text-xl mx-auto mb-4 shadow-lg shadow-gold-500/25">L</span>
 ...
 <p className="font-display font-bold text-white mb-2">Link Expired or Invalid</p>
 <p className="text-zinc-500 text-sm mb-6">This password reset link has expired or already been used. Request a new one.</p>
 <a href="/admin/login" className="inline-flex items-center gap-2 px-6 py-3 bg-gold-500 text-white text-sm font-semibold hover:bg-gold-600 transition-colors">
 Back to Login
 </a>
 </div>
 ) : (
 ...
 className={`w-full px-4 py-3 border bg-zinc-800 text-white text-sm placeholder-zinc-700 focus:outline-none focus:ring-1 focus:border-gold-500/50 focus:ring-0 transition-all ${
 confirm.length > 0
 ...
 className="w-full py-3.5 bg-gold-500 text-white font-bold text-sm hover:bg-gold-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all">
 {loading ? (
