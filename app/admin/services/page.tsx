...
export default function AdminServices() {
 ...
 const openNew = () => {
 setEditing({ ...EMPTY, id: "", sort_order: services.length } as Service);
 setIsNew(true);
 };
 ...
 {/* Title */}
 <div>
 <label className="block text-[10px] font-bold tracking-[0.2em] uppercase text-zinc-500 mb-2">Service Title *</label>
 ...
 <div>
 <label className="block text-[10px] font-bold tracking-[0.2em] uppercase text-zinc-500 mb-2">Subtitle (shown on services page as heading)</label>
 ...
 <div>
 <label className="block text-[10px] font-bold tracking-[0.2em] uppercase text-zinc-500 mb-2">Short Description (shown on cards)</label>
 ...
 {/* Features */}
 <div>
 <label className="block text-[10px] font-bold tracking-[0.2em] uppercase text-zinc-500 mb-2">Features (one per line — shown on Services page)</label>
 <textarea value={editing.features}
 ...
 {/* Icon */}
 <div>
 <label className="block text-[10px] font-bold tracking-[0.2em] uppercase text-zinc-500 mb-2">Icon</label>
 ...
 {/* Accent color */}
 <div>
 <label className="block text-[10px] font-bold tracking-[0.2em] uppercase text-zinc-500 mb-2">Accent Color</label>
 <div className="flex flex-wrap gap-2">
 {ACCENT_OPTIONS.map((acc) => (
 <button key={acc.value} onClick={() => setEditing({ ...editing, accent: acc.value, bg_color: acc.bg })}
 className={`px-4 py-2 text-sm font-medium border transition-all ${acc.bg} ${acc.value} ${
