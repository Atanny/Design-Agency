...
export default function AdminCommission() {
 ...
 <div className="h-32 bg-zinc-900 animate-pulse" />
 ...
 className="flex-1 py-2.5 text-sm font-bold transition-all border disabled:opacity-40 border-emerald-500/40 text-emerald-400 hover:bg-emerald-500/10 disabled:cursor-not-allowed"
 >
 ✓ Open Commissions
 </button>
 <button
 ...
 className="flex-1 py-2.5 text-sm font-bold transition-all border disabled:opacity-40 border-red-500/40 text-red-400 hover:bg-red-500/10 disabled:cursor-not-allowed"
 >
 ✕ Close Commissions
 </button>
 </div>
 ...
 <h3 className="font-display text-lg font-bold text-white mb-5">Banner Messages</h3>
 ...
 <div className="bg-[#0c0c0c] px-4 py-2.5 flex items-center justify-between gap-4">
 ...
 disabled={saving}
 className="mt-5 px-6 py-2.5 bg-gold-500 text-white text-sm font-black tracking-wide hover:bg-gold-600 disabled:opacity-50 transition-all"
 >
