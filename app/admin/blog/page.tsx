...
export default function AdminBlog() {
 ...
 className="px-3 py-1.5 border border-zinc-800 text-zinc-400 text-xs font-medium hover:text-white transition-colors">Edit</button>
 <button onClick={() => setConfirmDelete(post.id)}
 className="px-3 py-1.5 bg-red-500/20 text-red-400 text-xs font-medium hover:bg-red-500/30 transition-colors">Delete</button>
 </div>
 </div>
 ))}
 </div>
