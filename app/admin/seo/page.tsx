...
export default function AdminSeo() {
 ...
 {[...Array(4)].map((_, i) => <div key={i} className="h-40 bg-zinc-900 animate-pulse" />)}
 </div>
 ) : (
 ...
 return (
 <div key={page.key} className="p-6 border border-zinc-800 bg-zinc-900">
 ...
 className="px-5 py-2 bg-gold-500 text-white text-sm font-semibold hover:bg-gold-600 disabled:opacity-60 transition-colors"
 >
