...
const CATEGORIES = ["All", "UI/UX", "Branding", "Poster", "Social Media", "Website"];

// Skeleton loader
function SkeletonCard() {
  return (
    <div className="rounded-2xl overflow-hidden bg-zinc-100 dark:bg-zinc-800 animate-pulse aspect-[4/3]" />
  );
}
      ...
      >
        ...
        <div className="p-6 md:p-8">
          <div className="flex items-start justify-between gap-4">
            <div>
              <span className="inline-block px-2.5 py-1 rounded-full bg-gold-50 dark:bg-gold-900/30 text-gold-600 dark:text-gold-400 text-xs font-medium mb-3">
                {item.category}
              </span>
            ...
            <button
              onClick={onClose}
              className="flex-shrink-0 w-9 h-9 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center text-zinc-500 hover:text-zinc-900 dark:hover:text-white"
