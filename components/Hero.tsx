  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-24 pb-20">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        {/* Warm parchment base for light mode */}
        <div className="absolute inset-0 bg-[#f7f5f0] dark:bg-[#080808]" />

        {/* Abstract SVG art — top left blob cluster */}
        <svg className="absolute -top-24 -left-24 w-[500px] h-[500px] opacity-40 dark:opacity-20" viewBox="0 0 500 500" fill="none">
          ...
          <defs>
            <radialGradient id="g1" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="#e8bd5a" stopOpacity="0.5" />
        ...
        {/* Abstract SVG art — top right geometric */}
        <svg className="absolute -top-16 -right-16 w-[420px] h-[420px] opacity-30 dark:opacity-15" viewBox="0 0 420 420" fill="none">
          ...
          <defs>
            ...
            <radialGradient id="g5" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="#c8891a" stopOpacity="0.35" />
        ...
        {/* Abstract SVG art — bottom right */}
        <svg className="absolute -bottom-20 -right-10 w-[380px] h-[380px] opacity-25 dark:opacity-10" viewBox="0 0 380 380" fill="none">
          ...
          <defs>
            ...
            <radialGradient id="g8" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="#c8891a" stopOpacity="0.3" />
              <stop offset="100%" stopColor="#e8bd5a" stopOpacity="0" />
            </radialGradient>
          </defs>
        </svg>

        {/* Abstract SVG art — bottom left accent */}
        <svg className="absolute bottom-10 left-0 w-[280px] h-[280px] opacity-20 dark:opacity-10" viewBox="0 0 280 280" fill="none">
